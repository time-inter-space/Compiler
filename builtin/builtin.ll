...
define dso_local ptr @getString() local_unnamed_addr #2 {
  %1 = tail call dereferenceable_or_null(4096) ptr @malloc(i32 noundef 4096) #10
...
; Function Attrs: nounwind
define dso_local ptr @builtin.string.add(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
define dso_local zeroext i1 @builtin.string.eq(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
define dso_local zeroext i1 @builtin.string.ne(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #11
  %4 = icmp ne i32 %3, 0
  ret i1 %4
}
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
define dso_local zeroext i1 @builtin.string.lt(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #11
  %4 = icmp slt i32 %3, 0
  ret i1 %4
}
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
define dso_local zeroext i1 @builtin.string.le(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #11
  %4 = icmp slt i32 %3, 1
  ret i1 %4
}
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
define dso_local zeroext i1 @builtin.string.gt(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #11
  %4 = icmp sgt i32 %3, 0
  ret i1 %4
}
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
define dso_local zeroext i1 @builtin.string.ge(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
  %3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #11
  %4 = icmp sgt i32 %3, -1
  ret i1 %4
}
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
define dso_local i32 @builtin.string.length(ptr nocapture noundef readonly %0) local_unnamed_addr #5 {
  %2 = tail call i32 @strlen(ptr noundef nonnull dereferenceable(1) %0) #11
  ret i32 %2
}

; Function Attrs: nounwind
define dso_local ptr @builtin.string.substring(ptr noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  %4 = sub nsw i32 %2, %1
  %5 = add nsw i32 %4, 1
  ...
  %9 = getelementptr inbounds i8, ptr %6, i32 %5
  store i8 0, ptr %9, align 1, !tbaa !8
  ret ptr %6
}

; Function Attrs: nofree nounwind
define dso_local i32 @builtin.string.parseInt(ptr nocapture noundef readonly %0) local_unnamed_addr #2 {
...
define dso_local i32 @builtin.string.ord(ptr nocapture noundef readonly %0, i32 noundef %1) local_unnamed_addr #6 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read)
define dso_local i32 @builtin.array.size(ptr nocapture noundef readonly %0) local_unnamed_addr #6 {
...
define dso_local noalias nonnull ptr @builtin.new.array(i32 noundef %0, i32 noundef %1) local_unnamed_addr #7 {
  %3 = mul nsw i32 %1, %0
  %4 = add nsw i32 %3, 4
...
define dso_local noalias ptr @builtin.new.var(i32 noundef %0) local_unnamed_addr #8 {
